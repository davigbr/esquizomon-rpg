...
- Se o jogador citar o nome de uma carta no diário, o app recompensa +10 XP automaticamente (por menção, uma vez por dia) — comente quando perceber o conceito em uso, sem anunciar a mecânica por extenso.
